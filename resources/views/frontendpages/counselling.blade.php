...
<div class="flex justify-center my-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class=" z-0">
             ...
             <p class="text-white text-lg mb-4">
               Counseling is a collaborative process where a trained professional helps individuals, couples, or families address emotional, psychological, and behavioral challenges. It provides a safe and confidential space to explore feelings, thoughts, and experiences, and to develop strategies for personal growth and well-being.
              </p>
              <h4 class="text-xl font-semibold text-white mb-3">Benefits of Counseling</h4>
                <ul class="list-disc list-inside text-white text-lg">
                  <li>Improved mental health and emotional well-being.</li>
                  <li>Better coping mechanisms for stress, anxiety, and    depression.</li>
                  <li>Increased self-awareness and self-esteem.</li>
                 <li>Support during life transitions, grief, or trauma.</li>
               </ul>
    ...
    <h2 class="text-3xl font-semibold text-#113946-800">Connect With Us</h2>
    ...
    <form action="" method="POST">
        @csrf
            <!-- Counseling Type Field -->
            <div class="mb-4">
            <label for="counselingType" class="block text-gray-700 text-lg font-medium">Type of Counseling Needed</label>
            <select id="counselingType" name="counselingType" class="custom-input " required>
                
                <option value="">Please select</option>
                <option value="Psychological Trauma">Psychological Trauma</option>
                <option value="Emotional Trauma">Emotional Trauma</option>
                <option value="Harām relationships">Guidance on leaving Harām relationships.</option>
                ...
                <option value="Self-esteem and Personal Growth">Self-esteem and Personal Growth</option>
                <option value="Family Therapy">Family Therapy</option>
                <option value="Child and Adolescent Counseling">Child and Adolescent Counseling</option>
            </select>
        </div>
           <!-- Mode of Communication Field -->
           <div class="mb-4">
            <label for="communicationMode" class="block text-gray-700 text-lg font-medium">Preferred Mode of Communication</label>
            <select id="communicationMode" name="communicationMode" class="custom-input" required>
                <option value="">Please select</option>
         ...
         <!-- Gender Field -->
         <div class="mb-4">
            <label for="gender" class="block text-gray-700 text-lg font-medium">Your Gender</label>
        ...
        <!-- Comfortable with Which Gender Field -->
        <div class="mb-4">
            <label for="comfortableGender" class="block text-gray-700 text-lg font-medium">Comfortable with which gender for counseling?</label>
            <select id="comfortableGender" name="comfortableGender" class="custom-input" required>
                <option value="">Please select</option>
                <option value="Male">Male</option>
                <option value="Female">Female</option>
        ...
        <div class="mb-4">
            <label for="contact" class="block text-gray-700 text-lg font-medium">Contact</label>
            <input type="contact" id="email" name="contact" class="custom-input" required>
        </div>
        <!-- Submit Button -->
